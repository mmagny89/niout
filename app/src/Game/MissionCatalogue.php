    ...
    private static function construire(): array
    {
        $missions = [
            new Mission(
                ...
                new GeographieDeRegion(nil: true, mediterranee: true, ressourcesDeZone: [Ressource::Argile, Ressource::Roseaux, Ressource::Calcaire]),
            ),
            new Mission(
            ...
            new Mission(
                ...
                new GeographieDeRegion(nil: true, desert: true, ressourcesDeZone: [Ressource::Calcaire, Ressource::Albatre, Ressource::Argile]),
            ),
            new Mission(
            ...
            new Mission(
                ...
                new GeographieDeRegion(desert: true, oasis: true, ressourcesDeZone: [Ressource::Argile, Ressource::Calcaire, Ressource::Natron]),
            ),
            new Mission(
